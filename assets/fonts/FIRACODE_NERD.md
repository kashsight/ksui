...
This is the font cvui's UI is designed around (icons in `lsd`, box-drawing in the banner, the KAI face glyphs).
...
If the download ever fails, cvui still works — the banner falls back to plain box-drawing and `lsd` icons degrade to a unicode theme.
